...
<div class="min-vh-100" style="padding-top:5rem; background: linear-gradient(160deg, #0A0E1A 0%, #0D1F3C 60%, #0A0E1A 100%);">
    <div class="container py-5">
        ...
        <div class="mb-5">
            <p class="font-bebas text-red-op mb-1" style="letter-spacing:0.3em;">✏️ Editar Clase</p>
                    ...
                    <form method="POST" action="/admin/clases/{{ $clase->id }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" value="{{ $clase->nombre }}"
                                   class="form-control bg-deep text-white border-gold @error('nombre') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="horario" value="{{ $clase->horario }}"
                                   class="form-control bg-deep text-white border-gold @error('horario') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="instructor" value="{{ $clase->instructor }}"
                                   class="form-control bg-deep text-white border-gold @error('instructor') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="cupos" value="{{ $clase->cupos }}"
                                   class="form-control bg-deep text-white border-gold @error('cupos') is-invalid @enderror" required>
